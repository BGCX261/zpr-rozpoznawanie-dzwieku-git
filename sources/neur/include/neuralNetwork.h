...
{
public:
	void initializeNetwork(unsigned long inputNeuronsNum, const std::auto_ptr< std::vector<LABEL> >& outputCategories);	/// initializes neural network with given number of inputs and outputs as given categories
