...
{
public:
	Teacher(float spectralResolution=20, unsigned short maximumFrequency=8000) : spectralResolution_(spectralResolution), maximumFrequency_(maximumFrequency), abortFlag_(false), learningDone_(false) {}
